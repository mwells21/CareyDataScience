...
ggplot(data = state_orders, aes(x = State, ymin = Start, ymax = End ))+
  geom_linerange()+
...
ggplot(data = state_orders, aes(x = State, ymin = 0, ymax = Duration ))+
  geom_linerange()+
  ...
  ylab("Days Since Start of Stay-at-Home Order")+
